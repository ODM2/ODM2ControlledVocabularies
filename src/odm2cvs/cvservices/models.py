...
class ControlledVocabulary(models.Model):
    ...
    previous_version = models.OneToOneField('self', on_delete=models.CASCADE, null=True, related_name='revised_version')
...
class ControlledVocabularyRequest(models.Model):
    ...
    request_for = models.ForeignKey('ControlledVocabulary', on_delete=models.CASCADE, db_column='requestFor', blank=True, null=True)
    original_request = models.ForeignKey('self', on_delete=models.CASCADE, db_column='originalRequestId', null=True)
